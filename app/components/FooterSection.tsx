  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: "absolute", marginLeft: -162, marginTop: 100 }}>
          <Typography
            component="span"
            variant="h1"
            sx={{
      ...
      <div className="items-center text-center">
        ...
        >
          www.fiem-hackspire.com
        </Typography>
      </div>
      <Box
        className="items-center text-center flex flex-row mt-5"
        sx={{ width: { xs: 30, sm: 100 }, marginLeft: { sm: -32, xs: -20 } }}
      >
        <img
