    ...
    <div className="sm:pt-40 xl:pt-40">
      ...
      <div className="justify-center" style={{ fontFamily: "blanka" }}>
        <div className="gird grid-row-2 grid-flow-col justify-center text-center w-30">
          ...
          <p className="font-bold lg:indent-[30%] text-5xl text-white"> PATRONS</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-20 p-8 md:p-12 lg:px-16 lg:py-24 lg:mt-10 ">
          ...
          <div className="w-45 bg-inherit  sm:max-lg:py-10">
            ...
            <div className="-mt-4 sm:flex sm:items-center sm:justify-end sm:gap-3">
              <strong className="font-bold sm:max-lg:text-xl text-2xl text-[#1DD8FE]" style={{fontFamily:"blanka"}}>
                PATRON
              </strong>
          ...
          <div className="w-45 sm:max-lg:py-10">
            <div className="flex justify-center align-items-center border-r-4 border-[#1DD8FE]">
              <div className="w-3/4 lg:ml-12">
                <article className="hover:animate-background rounded-tl-3xl rounded-br-3xl  bg-white/10 p-0.5 shadow-xl transition hover:bg-[#5CE1E6] hover:shadow-sm dark:shadow-gray-700/25">
                  <div className="rounded-[10px] p-4 sm:p-6 ">
                ...
                <div className="mt-4 sm:flex sm:items-center sm:justify-center">
                  <strong className="font-regular text-xl sm:max-lg:text-base text-white">
                    Prof. (Dr.) Jaydip Nath
                  </strong>
                </div>
                <div className="mt-2 mb-5 sm:flex sm:items-center sm:justify-center">
